...
export default function ProjectCard({
    ...
    return (
        <div
            className={`group border border-dashed border-white/10 p-2 h-100 w-100 hover:border-white/30 hover:bg-white/2 ${className}`}
        >
            <Image
                src={image}
            ...
            <div className="p-2">
                <div className="flex items-center justify-between gap-2">
                    <h1 className="text-white text-[18px] font-instrument-serif">
                        {name}
                    </h1>
                ...
                <p className="text-white/50 text-[12px] font-Geist_Mono">
                    {desc}
                </p>
            </div>
        </div>
